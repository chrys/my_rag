...
class TestChatMessageModel:
    ...
    def test_create_user_message(self, project, authenticated_user) -> None:
    ...
    def test_create_assistant_message(self, project) -> None:
    ...
    def test_message_timestamps(self, project) -> None:
    ...
    def test_message_string_representation(self, project) -> None:
    ...
    def test_message_string_representation_truncated(self, project) -> None:
    ...
    def test_context_documents_default(self, project) -> None:
    ...
    def test_context_documents_json(self, project) -> None:
    ...
    def test_system_prompt_stored(self, project) -> None:
    ...
    def test_session_id_blank(self, project) -> None:
    ...
    def test_message_ordering(self, project) -> None:
    ...
    def test_queryset_filter_by_session(self, project) -> None:
    ...
    def test_queryset_filter_by_message_type(self, project) -> None:
    ...
    def test_message_user_optional(self, project) -> None:
    ...
    def test_cascade_delete_project(self, project, authenticated_user) -> None:
    ...
    def test_user_set_to_null_on_deletion(self, project, authenticated_user) -> None:
    ...
    def test_valid_message_types(self, project) -> None:
    ...
    def test_project_related_access(self, project, authenticated_user) -> None:
    ...
    def test_user_related_access(self, project, authenticated_user) -> None:
