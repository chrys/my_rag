# Task 1: Admin Parameters 
- Administrators should be able to enable / disable features of each project. 
- At the current Admin Tab add a section after the files uploaded that will have the following parameters: 
1. Synthesizer enabled: boolean, enables/disables synthesizer that will be described in Task 2 below. 




# Task2: Prompt Isolation & Citation Synthesis represents
